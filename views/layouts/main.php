            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class="logo pull-left">
                        <a href="<?= Url::home() ?>"><?= Html::img('@web/images/home/logo.png', ['alt' => 'Gillette']) ?></a>
                    </div>
...
Modal::begin([
    ...
    'footer' =>
        ...
        <button type='button' class='btn btn-warning'  onclick='clearCart(); return false;'>Очистить</button>
